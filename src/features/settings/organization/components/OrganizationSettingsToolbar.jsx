...
export function OrganizationSettingsToolbar({
  ...
  return (
    <SettingsPageToolbar
      title="Organization"
      subtitle="Company profile and the holiday calendar employees follow across your organization."
      secondaryActions={
        showUploadExcel && onUploadExcel ? (
          <Button
            variant="outlined"
      ...
      primaryAction={
        showAddHoliday && onAddHoliday ? (
          <CrudButton intent="create" startIcon={<AddIcon />} onClick={onAddHoliday} sx={{ whiteSpace: 'nowrap' }}>
            Add holiday
          </CrudButton>
        ) : null
      }
