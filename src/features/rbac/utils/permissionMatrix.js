...
function formatResourceLabel(resource) {
  const labels = {
    ...
    'ess.attendance.swipes': 'Employee Swipes',
    'ess.attendance.regularization': 'Attendance regularization',
    'ess.timesheet': 'ESS Timesheet',
    'approvals.leave': 'Leave approvals',
    'approvals.timesheet': 'Timesheet approvals',
    'approvals.attendance': 'Attendance regularization approvals',
    payroll: 'Payroll',
    rbac: 'Roles & Permissions',
    'dashboard.ess': 'Employee home dashboard',
    'dashboard.ess.team-on-leave': 'Team On Leave (home)',
    'dashboard.ess.track': 'Track (home)',
    'dashboard.ess.who-is-in': 'Who is in (home)',
